...
const TRACKING_PARAMS = new Set([
  ...
  'gclid', 'dclid', 'gbraid', 'wbraid', 'srsltid',
  'campaign_id', 'campaign_medium', 'campaign_name', 'campaign_source', 'campaign_term', 'campaign_content',
  'twclid', 'msclkid',
  'mc_cid', 'mc_eid', 'mc_tc',
  'hsa_cam', 'hsa_grp', 'hsa_mt', 'hsa_src', 'hsa_ad', 'hsa_acc', 'hsa_net', 'hsa_ver', 'hsa_la', 'hsa_ol', 'hsa_kw', 'hsa_tgt',
  '_hsenc', '_hsmi', '__hssc', '__hstc', '__hsfp',
  '_bhlid', 'mkt_tok', 'vero_id', 'vero_conv', 'yclid', 'ysclid', 'sc_cid',
  'ref_src', 'ref_url', '_openstat',
  'ns_source', 'ns_campaign', 'ns_mchannel', 'ns_linkname', 'ns_fee',
  'igshid', 'si',
])
