...
import { SwipeableArticleCard } from '@/components/article/swipeable-article-card'
import { ArticleOverlay } from '@/components/article/article-overlay'
...
export function ArticleList() {
  ...
  useEffect(() => {
    ...
    // Measure actual header height in pixels
